...
RUN yum install -y yum-utils https://centos7.iuscommunity.org/ius-release.rpm \
    ...
    && yum clean all \
    && rm -rf /var/cache/yum \
    && curl -fSL -O https://cdn.crate.io/downloads/releases/nightly/crate-3.3.0-201902160201-5ffb804.tar.gz \
    && export GNUPGHOME="$(mktemp -d)" \
    && gpg --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys 90C23FC6585BC0717F8FBFC37FAAE51A06F6EAEB \
    && tar -xf crate-3.3.0-201902160201-5ffb804.tar.gz -C /crate --strip-components=1 \
    && rm crate-3.3.0-201902160201-5ffb804.tar.gz \
...
LABEL maintainer="Crate.io <office@crate.io>" \
    ...
    org.label-schema.build-date="2019-02-16T18:57:24.937639748+00:00" \
